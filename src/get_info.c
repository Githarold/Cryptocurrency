...
void get_info(const char* url) {
    ...
    json_object *data, *trade_price, *opening_price, *high_price, *low_price, *candle_acc_trade_volume;
    ...
    coin_data.trade_coef = (coin_data.trade_price-0.95*coin_data.opening_price)*SCREEN_HEIGHT*10/coin_data.opening_price;
    coin_data.high_coef = (coin_data.high_price-0.95*coin_data.opening_price)*SCREEN_HEIGHT*10/coin_data.opening_price;
    coin_data.low_coef = (coin_data.low_price-0.95*coin_data.opening_price)*SCREEN_HEIGHT*10/coin_data.opening_price;
    coin_data.opening_coef = (coin_data.opening_price-0.95*coin_data.opening_price)*SCREEN_HEIGHT*10/coin_data.opening_price;
